      ...
      <div className="page-wrap">
          <div className="container h-100 ">
              <div className="row h-100 justify-content-center">
                  <div className="col-lg-6 my-auto text-center" data-aos="fade-up">
                      <div className="mb-3">
                      ...
                      <div className="mb-3">
                          ...
                          <Link className="btn btn-primary mt-3 w-50" to={`/ghotube/search?q=${(query) ? query : 'trending'}`}>Search</Link>
                      </div>
                  </div>
              </div>
          </div>
